...
public interface CartController {
	...
	public @ResponseBody String addGoodsInCart(@RequestParam("goods_uroom") int goods_uroom,HttpServletRequest request, HttpServletResponse response)  throws Exception;
