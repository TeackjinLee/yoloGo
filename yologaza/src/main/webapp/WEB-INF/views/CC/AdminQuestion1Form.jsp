        	...
        	<div class="dropdown">
            	<button class="dropbtn" onclick="dropdown()">
                    ...
                    <div class="dropdown-content">
                      <div class="type" onclick='showMenu(this.innerText); location.href="${contextPath}/CC/admin_frequentList.do?auth=1";'>사용자 공지사항 조회</div>
                      <div class="type" onclick='showMenu(this.innerText); location.href="${contextPath}/CC/admin_frequentList.do?auth=2";'>사업자 공지사항 조회</div>
                  	</div>
            </div>
        	</li>
        	</ul>
