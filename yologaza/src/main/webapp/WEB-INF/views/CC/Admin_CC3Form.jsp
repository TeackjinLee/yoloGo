...
.div_bot .dropdown button::before{
  content: "\f078";
...
<body class="pc">
  <form name="frmAnnounce" method="post"  action="${contextPath}/CC/admin_addAnnounce.do"  enctype="multipart/form-data">
    <div class="wrap show">
